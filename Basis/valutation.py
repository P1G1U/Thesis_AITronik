...
model.model_cnn.load_weights("models/cp-epoch-train0.00.4.ckpt")
...
def get_data(filename):
    ...
    data_tensor_test.targets=tf.reshape(data_test.targets,[-1,2])
...
print("loading 2303 mono direction....")

data, data_tensor = get_data("laser_log/laser_log2303_unidir.csv")

print("evaluating 2303 mono direction....")

pos_test, pos_real = evaluate(model, data, data_tensor)
